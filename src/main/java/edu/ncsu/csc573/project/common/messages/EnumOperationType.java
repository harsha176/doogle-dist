...
public enum EnumOperationType {
	...
	REGISTERRESPONSE, LOGINRESPONSE, LOGOUTRESPONSE, SEARCHRESPONSE, PUBLISHRESPONSE, FORGOTPASSWORDRESPONSE, CHANGEPASSWORD, CHANGEPASSWORDRESPONSE, INVALIDRESPONSE, JOIN, JOINRESPONSE, LEAVE, LEAVERESPONSE, GET, GETRESPONSE, PUT, PUTRESPONSE, ACKRESPONSE, UPDATE
}
