 ...
 *         &lt;element name="File" type="{http://www.doogle.project.csc573.csc.ncsu.edu}DownloadFileParamType" maxOccurs="100"/>
...
public class JoinResponseTypeParams {
    ...
    protected List<DownloadFileParamType> file;
     ...
     * {@link DownloadFileParamType }
     * 
     * 
     */
    public List<DownloadFileParamType> getFile() {
        if (file == null) {
            file = new ArrayList<DownloadFileParamType>();
        }
        return this.file;
    }
